...
<body style="overflow-x:hidden ;" id="body">
    ...
    <div class="bordr" style="border-top: 1px solid #ccc; position:fixed;bottom:70px;left:280px;width: 100%px;">
    </div>
    <div class="page" id="page">
        ...
        $id = $_GET['fact'];
        $connexion = mysqli_connect('localhost', 'root', '', 'Stock') or die(mysqli_error($connexion));
        $query = $connexion->query("SELECT * FROM produit WHERE id='$id'");
        ...
        <div class="bodyFact">
            ...
            <div class="champs">
                <div class="left">
                    <p><b>Categorie:</b><?php echo $row['Categorie'] ?></p>
                    <p><b>Marge:</b> 50%</p>
                </div>
                <div class="center">
                    <img src="../img/bt.jpg" height="50" width="50" alt="" style="position:relative;bottom:60px;left:70px;">
                    <img src="../img/barcode .jpg" height="50" width="95" alt="">
                    <p><?php echo $row['Code barre'] ?></p>
                </div>
                <div class="right">
                    <p><b>Qte_stock:</b><?php echo $row['QTE_Stock'] ?></p>
                    <p><b>Prix_U:</b><?php echo $row['Prix_U'] ?></p>
                    <p><b>Unite:</b><?php echo $row['Unite'] ?></p>
                </div>
            </div>
        </div>
        <div class="footFact">
            <p><b>Prix_Vente:</b><?php echo $row['Prix_Vente'] ?></p>
        </div>
