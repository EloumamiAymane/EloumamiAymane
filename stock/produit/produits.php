    ...
    <div class="list-prod">
        <div class="row">
            ...
            <div class="lks">
                ...
                <a href="" style="text-decoration: none;color:grey;"> Lists Produit</a>
            </div>
        </div>
    </div>
    ...
    <div class="bg">
        <div class="list-prod">
            <table class="content-tab" style="width:75% ;position:relative;right:530px;">
                ...
                <tbody>
                    <?php foreach ($prod as $prods) :  ?>
                        <tr data-href="print.php?fact=<?php echo $prods['id']; ?>">
                            <a href="#">
                                <td><?php echo $prods['Designation'] ?></td>
                                <td><?php echo $prods['Code barre'] ?></td>
                                <td><?php echo $prods['Categorie'] ?></td>
                                <td><?php echo $prods['QTE_Stock'] ?></td>
                                <td><?php echo $prods['Unite'] ?></td>
                                <td><?php echo $prods['Prix_U'] ?></td>
                                <td><?php echo $prods['Prix_Vente'] ?></td>
                                <td>
                                    <a href="UpdateProd.php?edit=<?php echo $prods['id']; ?>" class="btnn1" style="text-decoration: none;color:black;"> <i class="fas fa-edit"></i> edit </a>
                                    <a href="deleteProd.php?delete=<?php echo $prods['id']; ?>" class="btnn" style="text-decoration: none;color:black;"> <i class="fas fa-trash"></i> delete </a>
                                </td>
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    <li class="page-item"><a class="page-link" href="produits.php?page=<?= $Previous; ?> ">Previous</a></li>
                    <?php for ($i = 1; $i <= $pages; $i++) : ?>
                        <li class="page-item"><a class="page-link" href="produits.php?page=<?= $i; ?>"><?= $i; ?></a></li>
                    <?php endfor; ?>
                    <li class="page-item"><a class="page-link" href="produits.php?page=<?= $Next; ?>">Next</a></li>
                </ul>
            </nav>
