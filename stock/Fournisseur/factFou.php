...
<body>
    ...
    <div class="page">
        ...
        $id = $_GET['fact'];
        $connexion = mysqli_connect('localhost', 'root', '', 'Stock') or die(mysqli_error($connexion));
        $query = $connexion->query("SELECT * FROM fournisseur WHERE id='$id'");
        ...
        <div class="bodyFact">
            <div class="desPro">
                <p style="font-size: 20px; position:relative;right:50px;"> <b style=" font-size: 20px;"> Raison Sociale :</b>
                    <?php echo $row['RaisonSocialefour'] ?></p>
            </div>
            <div class="champs">
                <div class="left">
                    <p><b>Nom:</b><?php echo $row['NameFour'] ?></p>
                    <p><b>Tel:</b><?php echo $row['telfour'] ?> </p>
                    <p><b>Email:</b><?php echo $row['emailfour'] ?></p>
                    <p><b>Adresse:</b><?php echo $row['adressefour'] ?></p>
                </div>

                <div class="right">
                    <p><b>Ville:</b><?php echo $row['villefour'] ?></p>
                    <p><b>fax:</b><?php echo $row['faxfour'] ?></p>
