...
if (isset($_POST['update'])) {
    ...
    $update_data = "UPDATE fournisseur SET 
    
    
      RaisonSocialefour='$RS',
      telfour='$tel' ,
      emailfour='$email',
      faxfour='$fax',
      villefour='$ville',
...
<body style="height: 150px;">
    ...
    <div class="block" style="height: 550px;">
        ...
        <div class="modal-header" style="  background-color:#4D77FF; height: 60px; position:relative;bottom:36px;">

            <h3 style="position: relative; ;left:50px;top:5px;color:#fff;">Modifier Fournisseur</h3>
        ...
        $query = $connexion->query("SELECT * FROM fournisseur where id='$idf'");
        ...
        ?>
            ...
            <form class="row g-3 needs-validation" method="post">
                ...
                <div class="col-md-4" style="position: relative; top:0px; left:50px;">
                    <label class="form-label">Raison Sociale</label>
                    <input type="txt" class="form-control" style="width:400px;" name=" RS" placeholder="<?php echo $row['RaisonSocialefour'] ?>">
                    <div class="valid-feedback">
                        Looks good!
                    </div>
                </div>

                <div class="col-md-4" style="position: relative; top:0px;left:170px; width: 280px;">

                    <label for="formFile" class="form-label">Tel</label>
                    <input type="txt" class="form-control" style="width:380px;" name="tel" placeholder="<?php echo $row['telfour'] ?>">
                ...
                <div class="col-md-6" style="position: relative; top:80px;">
                    ...
                    <input type="txt" class="form-control" name="fax" id="validationCustom03" required style="width:400px;position: relative;left: 50px;bottom: 70px;" placeholder="<?php echo $row['faxfour'] ?>">
                ...
                <div class="col-md-4" style="position: relative; top:10px; width: 400px;">
                    ...
                    <div class="input-group has-validation">
                        ...
                        <input type="txt" class="form-control" name="adr" id="validationCustomUsername" aria-describedby="inputGroupPrepend" required placeholder="<?php echo $row['adressefour'] ?>">
                        <div class="invalid-feedback">
                ...
                <div class="col-md-3" style="position: relative; top:20px; left:50px;width: 418px;">
                    ...
                    <input type="txt" class="form-control" name="Ville" id="validationCustom05" required placeholder="<?php echo $row['villefour'] ?>">
                    <div class="invalid-feedback">
                ...
                <div class="col-md-3" style="position: relative; top:20px; left:90px;width: 400px;">
                    ...
                    <input type="text" class="form-control" name="mail" id="validationCustom05" required placeholder="<?php echo $row['emailfour'] ?>">
                    <div class="invalid-feedback">
                        Please provide a valid zip.
                    </div>
                </div>
            ...
            <div class="col-12" style="position:relative ; top:80px; left:860px; ">
