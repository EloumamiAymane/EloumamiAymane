    ...
    <div class="bg">
        <div class="list-prod">
            <table class="content-tab" style="width:75%; position:relative;right:560px;">
                ...
                <tbody>
                    <?php foreach ($four as $fours) :  ?>
                        <tr data-href="factFou.php?fact=<?php echo $fours['id']; ?>">
                            <td><?php echo $fours['NameFour'] ?></td>
                            <td><?php echo $fours['RaisonSocialefour'] ?></td>
                            <td><?php echo $fours['telfour'] ?></td>

                            <td><?php echo $fours['emailfour'] ?></td>
                            <td><?php echo $fours['villefour'] ?></td>




                            <td style="position: relative; right:40px;">
                                <a href="updateFour.php?edit=<?php echo $fours['id']; ?>" class="btnn1" style="text-decoration:none ;color:black;"> <i class="fas fa-edit"></i> edit </a>
                                <a href="deletFour.php?del=<?php echo $fours['id']; ?>" class="btnn" style="text-decoration:none ;color:black;"> <i class="fas fa-trash"></i> delete </a>
                            </td>
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    <li class="page-item"><a class="page-link" href="fournisseur.php?page=<?= $Previous; ?> ">Previous</a></li>
                    <?php for ($i = 1; $i <= $pages; $i++) : ?>
                        <li class="page-item"><a class="page-link" href="fournisseur.php?page=<?= $i; ?>"><?= $i; ?></a></li>
                    <?php endfor; ?>
                    <li class="page-item"><a class="page-link" href="fournisseur.php?page=<?= $Next; ?>">Next</a></li>
                </ul>
            </nav>
