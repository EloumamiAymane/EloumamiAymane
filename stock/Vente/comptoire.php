    ...
    <div class="bg">
        <div class="list-prod">
            <table class="content-tab" style="width:70% ;position:relative;right:520px;">
                ...
                $query = $connexion->query("SELECT * FROM facture where idF='$idf'");
                ...
                ?>
                    ...
                    <tbody>
                        ...
                        <tr data-href="suiviAchat.php?fact=<?php echo $_GET['fact'] ?>&numFact=<?php echo $row['NumFacture'] ?>">
                            ...
                            <a href="#">
                                ...
                                <td>
                                    ...
                                    <a href="deletefactur.php?delete=<?php echo $_GET['fact'] ?>&NumFact=<?php echo $row['NumFacture'] ?>" class="btnn" style="text-decoration:none;color:black;padding-left:15px;"> delete </a>

                                    <?php if ($row['Validation'] == 1) : ?>
                                        <a href="factureSortie.php?fact=<?php echo $_GET['fact'] ?>&NumFact=<?php echo $row['NumFacture'] ?>" class="btnn" style="background-color:rgb(229, 171, 57) ;border: none;text-decoration:none;color:black;padding-left:15px;">facture</a>
                                    <?php else : ?>
