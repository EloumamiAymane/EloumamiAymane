...
if ($page == 0) {
    ...
    $result = $connexion->query("SELECT * FROM client LIMIT $start, $limit");
    $clt = $result->fetch_all(MYSQLI_ASSOC);


    $result1 = $connexion->query("SELECT count(id) AS id from client");
...
<body>
    ...
    <div class="list-prod">
        <div class="row">
            ...
            <div class="lks">
                ...
                <a href="" style="text-decoration: none;color:grey;"> Lists clients</a>
            </div>
        </div>
    </div>
    ...
    <div class="form">
        ...
        <div class="bt">
            ...
            <a href="../Client/listClt.php"> <button type="button" id="btn1" class="btn btn-primary" data-bs-target="#exampleModal" style="background-color:rgb(158, 158, 21);border: none;">
                    Download
                </button></a>
        ...
        <div class="search" style="position: relative; bottom:250px; left:710px;z-index:100;">
            ...
            <form class="d-flex" role="search" action="../Client/searchClt.php">
            ...
            <div class="modal-dialog">
                <div class="modal-content" style="width:700px;">
                    <div class="modal-header" style="  background-color: #1DBF57;height:60px;">
                        <img src="../img/client.fpg.jfif" alt="" height="50px;" width="50px;" style="border-radius:20px ;">
    ...
    <div class="bg">
        ...
        <div class="list-prod">
            <table class="content-tab" style="width:78%; position:relative;right:560px;">
                ...
                <tbody>
                    <?php foreach ($clt as $clts) :  ?>
                        <tr data-href="printcl.php?fact=<?php echo $clts['id']; ?>">
                            <td><?php echo $clts['Nameclt'] ?></td>
                            <td><?php echo $clts['RaisonSocialeClt'] ?></td>
                            <td><?php echo $clts['telclt'] ?></td>

                            <td><?php echo $clts['emailclt'] ?></td>
                            <td><?php echo $clts['ville'] ?></td>
                            <td><?php echo $clts['adresseclt'] ?></td>



                            <td>
                                <a href="updateFClient.php?edit=<?php echo $clts['id']; ?>" class="btnn1" style="text-decoration:none ;color:black;"> <i class="fas fa-edit"></i> edit </a>
                                <a href="deleteClient.php?del=<?php echo $clts['id']; ?>" class="btnn" style="text-decoration:none ;color:black;"> <i class="fas fa-trash"></i> delete </a>
                            </td>
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    <li class="page-item"><a class="page-link" href="client.php?page=<?= $Previous; ?> ">Previous</a></li>
                    <?php for ($i = 1; $i <= $pages; $i++) : ?>
                        <li class="page-item"><a class="page-link" href="client.php?page=<?= $i; ?>"><?= $i; ?></a></li>
                    <?php endfor; ?>
                    <li class="page-item"><a class="page-link" href="client.php?page=<?= $Next; ?>">Next</a></li>
                </ul>
            </nav>
