...
<body>
    ...
    <div class="bg">
        ...
        <div class="list-prod">
            <table class="content-tab" style="width:75%; position:relative;right:540px;">
                ...
                if (isset($_GET['searchBtn'])) {
                    ...
                    $query = $connexion->query("SELECT * FROM client where  Nameclt like '%$searchValue%'");
                ...
                ?>
                        ...
                        <tbody>
                            <tr data-href="printcl.php?fact=<?php echo $row['id']; ?>">
                                ...
                                <td>
                                    <a href="updateFClient.php?edit=<?php echo $row['id']; ?>" class="btnn1"> <i class="fas fa-edit"></i> edit </a>
                                    <a href="deleteClient.php?del=<?php echo $row['id']; ?>" class="btnn"> <i class="fas fa-trash"></i> delete </a>
                                </td>
