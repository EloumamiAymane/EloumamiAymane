...
<body>
    ...
    $query = $connexion->query("SELECT * FROM societe,client,facturesortie where 
     facturesortie.idclt=client.id and facturesortie.idFClt='$factr' and client.id= '$idf'");
    ...
    ?>
        ...
        <div class="middle" style="border:1px solid #000; width:300px; text-align:left; padding-left:15px;position:relative;left:440px;bottom:100px;">
            <p><b>Facture N:</b><?php echo $row['idFClt'] ?></p>
    ...
    <a href="sortie.php">
        <button type="button" id="btn1" class="btn btn-primary" data-bs-target="#exampleModal" style="background-color:grey ;border: none;position:absolute;bottom:600px;left:80px;">
    ...
    <button id="btn1" onclick="window.print();" class="btn btn-primary" data-bs-target="#exampleModal" style="background-color:rgb(158, 158, 21);border: none; position:relative;left:1090px;bottom:45px;">
        Download
    </button>
