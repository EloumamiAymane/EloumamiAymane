             ...
             <table class="content-tab" style="width:70% ;position:relative;right:530px;">
                 <?php
                    ...
                    if (isset($_GET['searchBtn'])) {
                        ...
                        $query = $connexion->query("SELECT * FROM facturesortie where  idFClt like '%$searchValue%'");
                    ...
                    ?>
                         ...
                         <tbody>
                             ...
                             <tr data-href="suiviVente.php?clt=<?php echo $row['idclt'] ?>&NumFact=<?php echo $row['idFClt'] ?>">
                                 <a href="#">
                                     ...
                                     <td>
                                         <?php if ($row['validation'] != 1) : ?>
                                             <a href="deleteFactr.php?delete=<?php echo $row['idclt'] ?>&NumFact=<?php echo $row['idFClt'] ?>" class="btnn"> <i class="fas fa-trash"></i> delete </a>
                                         <?php else : ?>
                                             <a href="factureVente.php?clt=<?php echo $row['idclt'] ?>&NumFact=<?php echo $row['idFClt'] ?>" class="btnn" style="background-color:rgb(229, 171, 57) ;border: none;"> Imprimer </a>
                                     </td>
