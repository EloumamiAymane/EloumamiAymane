...
if (isset($_POST['ajouter'])) {
    $NumV = $_POST['NumV'];
    $date = $_POST['date'];
    $_SESSION['idclt'] = $_GET['clt'];
    //modifier

    $idf = $_GET['clt'];

    if (!empty($NumV) && !empty($date) && !empty($idf)) {

        $query = "INSERT INTO facturesortie (`idFClt`,`Date`,`idclt`)
Values ('$NumV','$date','$idf')";
    ...
    alert('Data saved');
            ...
            header("location: FormFacture.php?clt=$idf");
        } else {
            echo "<script>
    alert('Ooops!');
</script>";
...
<body>
    ...
    <div class="list-prod">
        <div class="row">
            ...
            <div class="lks">
                ...
                <a href="" style="text-decoration: none;color:grey;">Comptoire</a>
            </div>
        </div>
    </div>
    ...
    <div class="form">
        ...
        <div class="search" style="position: relative; bottom:250px; left:710px;z-index:100;">
            ...
            <form class="d-flex" role="search" action="../Achat/search.php">
    ...
    <div class="bg">
        <div class="list-prod">
            <table class="content-tab" style="width:70% ;position:relative;right:530px;">
                <?php
                $idclt = $_GET['clt'];
                $connexion = mysqli_connect('localhost', 'root', '', 'Stock') or die(mysqli_error($connexion));
                $query = $connexion->query("SELECT * FROM facturesortie where idclt='$idclt'");
                ...
                ?>
                    ...
                    <tbody>
                        ...
                        <tr data-href="suiviVente.php?clt=<?php echo $_GET['clt'] ?>&NumFact=<?php echo $row['idFClt'] ?>">
                            <a href="#">
                                ...
                                <td>
                                    ...
                                    <a href="deleteFactr.php?delete=<?php echo $_GET['clt'] ?>&NumFact=<?php echo $row['idFClt'] ?>" class="btnn" style="text-decoration:none;color:black;padding-left:15px;"> delete </a>
                                    <?php if ($row['validation'] == 1) : ?>
                                        <a href="factureVente.php?clt=<?php echo $_GET['clt'] ?>&NumFact=<?php echo $row['idFClt'] ?>" class="btnn" style="background-color:rgb(229, 171, 57) ;border: none;text-decoration:none;color:black;padding-left:15px;"> facture </a>
                                    <?php else : ?>
                                        <a href="" class="btnn" style="background-color:rgb(229, 171, 57) ;border: none;text-decoration:none;color:black;padding-left:15px;"> facture </a>
                                </td>
