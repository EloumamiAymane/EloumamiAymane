    ...
    <div class="list-prod">
        <div class="row">
            ...
            <div class="lks">
                ...
                <a href="" style="text-decoration: none;color:grey;"> Liste clients</a>
            </div>
        </div>
    </div>
    ...
    <div class="bg">
        <div class="list-prod">
            <table class="content-tab" style="width:75%; position:relative;right:530px;">
                ...
                <tbody>
                    <?php foreach ($four as $fours) :  ?>
                        <tr data-href="FormFacture.php?clt=<?php echo $fours['id'] ?>">
                            <td><?php echo $fours['Nameclt'] ?></td>

                            <td><?php echo $fours['telclt'] ?></td>

                            <td><?php echo $fours['emailclt'] ?></td>
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    <li class="page-item"><a class="page-link" href="sortie.php?page=<?= $Previous; ?> ">Previous</a></li>
                    <?php for ($i = 1; $i <= $pages; $i++) : ?>
                        <li class="page-item"><a class="page-link" href="sortie.php?page=<?= $i; ?>"><?= $i; ?></a></li>
                    <?php endfor; ?>
                    <li class="page-item"><a class="page-link" href="sortie.php?page=<?= $Next; ?>">Next</a></li>
                </ul>
            </nav>
